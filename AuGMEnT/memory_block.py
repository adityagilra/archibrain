...
class WMBlock(Layer):
    ...
    def __init__(self, output_dim, init='glorot_uniform',activation=None, weights=None, W_regularizer=None, b_regularizer=None, activity_regularizer=None,
	...
	self.output = zeros((1,self.output_dim))
