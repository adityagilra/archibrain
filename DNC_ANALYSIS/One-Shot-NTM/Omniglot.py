# Implementation of One-shot Neural Turing Machine described by A. Santoro in 'One-shot Learning with Memory-Augmented Neural Networks' (2016) to learn the omniglot task.
# Codes taken from https://github.com/hmishra2250/NTM-One-Shot-TF.
# ==============================================================================
...
def omniglot():
    ...
    #Load Data
    generator = OmniglotGenerator(data_folder='./data/omniglot', batch_size=batch_size, nb_samples=nb_class, nb_samples_per_class=nb_samples_per_class, max_rotation=30., max_shift=10., max_iter=100000)
