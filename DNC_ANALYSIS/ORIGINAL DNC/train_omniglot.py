...
# TASK: image classification task on the Omniglot dataset
#
# Author: Marco Martinolli
# ==============================================================================
"""Example script to train the DNC on Omniglot task."""
...
tf.flags.DEFINE_float("rot_max", np.pi/6, "Maximum absolute rotation of sample images.")
...
def train(num_trials, report_interval):
  ...
  with tf.train.SingularMonitoredSession(hooks=hooks, checkpoint_dir=FLAGS.checkpoint_dir) as sess:
    ...
    print('Omniglot Task - DNC - concatenated_input - ',FLAGS.hidden_size,'hidden - ',FLAGS.learning_rate,'lr')
