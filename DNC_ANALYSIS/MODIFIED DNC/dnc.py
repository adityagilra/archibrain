# MODIFICATION OF dnc.py of original DNC from https://github.com/deepmind/dnc.
# Changements to the original file are restricted to two points:
...
# - Additional option to decide wheter to concatenate the input with previous read vectors or not, via the conc_opt boolean variable (defualt is True)
#
...
#DNCState = collections.namedtuple('DNCState', ('controller_state'))
